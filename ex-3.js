...
// Start coding here
let totalBirdieSheplandPayment = 0;
for (let i = 0; i < orders.length; i++) {
  if (orders[i].customerName === "Birdie Shepland") {
    totalBirdieSheplandPayment += orders[i].productPrice * orders[i].productQuantity;
  }
}
console.log(`Total paid amount of Birdie Shepland: ${totalBirdieSheplandPayment.toLocaleString()} Baht`);